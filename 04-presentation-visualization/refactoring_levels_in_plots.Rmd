...
While the above graph shows the data/levels correctly ordered, the underlying levels of the data have not been changed. There's nothing wrong with doing your reordering within the `ggplot` call, but for consistency across visualizations and analysis, consider using `fct_*` functions inside of `mutate`.
