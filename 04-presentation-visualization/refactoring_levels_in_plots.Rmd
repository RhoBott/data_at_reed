...
For example say we wanted to make a plot comparing how many different species we have in the `palmerpenguins` dataset. Notice that the bars are ordered alphabetically when we'd rather have them ordered by `n`.
