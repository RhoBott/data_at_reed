...
The data is now uploaded to the server. You can now load the data into R in the same way you would if you were working with data stored on your computer with the desktop version of R. For more information on this topic, as well as specific instructions for loading different types of data, see the pages under the 'Loading Data' section of the [R tutorials page](https://www.reed.edu/data-at-reed/resources/R/index.html).
