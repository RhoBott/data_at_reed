...
In this data, every row is a unique observation (a penguin). For each penguin, you have the `species` of the penguin, which `island` it lives on, its `sex`, the `year` the measurements were taken, and some body size measurements.
