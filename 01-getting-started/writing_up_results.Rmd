...
Writing in an R Markdown document can be challenging, since markdown formatting and syntax can be both frustrating and unfamiliar. To help with this, RStudio has a visual editor for R Markdown documents, which feels much more similar to text editors such as Word or Google Docs.

The visual editor removes the need for remembering and using markdown formatting expressions, but still supports markdown expressions as well as traditional shortcuts and formatting icons. Visual mode also includes support for integration with Zotero for citation assistance.
