...
If writing in markdown formatting presents a challenge, RStudio has a visual editor for R Markdown documents, which feels much more similar to text editors such as Word or Google Docs. The visual editor removes the need for remembering and using markdown formatting expressions, but still supports markdown expressions as well as traditional shortcuts and formatting icons. Visual mode also includes support for integration with Zotero for citation assistance.

To start using the visual editor as well as learn more about the features available, check out RStudio's official [Visual R Markdown documentation page](https://rstudio.github.io/visual-markdown-editing/).
