...
This is the first few rows of a dataset that instead places every country-year pair on a separate row. The tidyr package is a good tool for transforming your data in this way to create new arrangements of the same information. With this new data setup, we can make a more informative graphic.
...
Layers are the elements that actually plot the data. If you forget to add a layer, it’ll just create an empty plot. After you define your data set and aesthetics inside the ggplotcommand, you can add on layers by just separating each one with a +.
