...
Regardless, now you've found the name of the dataset you want. From here, you can use the `data()` function. All you need to add is the name of the dataset.
...
If you've collected your own data using Excel, and now want to bring it into R, this process is made simple with the `readxl` package.
...
Similar to Excel files, you can also read in data that you've collected via Google Sheets using the `googlesheets4` package. Let's install and then load that package:
...
Check your "environment" in the top right corner of your R window, and you'll see your data in a nice data frame.
...
First, we'll save the URL of this site under a variable name so that it's easy to use later:
