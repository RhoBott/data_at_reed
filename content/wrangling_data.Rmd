...
For example, here's `penguins` as a tibble:
...
The reader can see the dimensions of the tibble (344 x 8), the variable names and their types, and the first ten rows. 
