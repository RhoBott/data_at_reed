...
### Making informative and readable graphs: how to add more variables

In addition to `x`, `y`, `color`, and `fill` covered in the [Intro to data visualization section](link), there are many other ways to represent even more variables with `ggplot2`, while keeping your graphs readable. Below are some additional methods for conveying more information on your graphs, or making your information more readable.
...
[This site](https://www.datanovia.com/en/blog/ggplot-aes-how-to-assign-aesthetics-in-ggplot2/#group-and-line-type) contains helpful examples on how to use each of these aesthetics, and highlights cases where they might be particularly appropriate.
