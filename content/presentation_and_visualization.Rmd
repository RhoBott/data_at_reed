...
On the [Data Wrangling](INSERT LINK TO DATA WRANGLING PAGE) page, we showed how to compute summary statistics for your data. Summary tables can be great for displaying data, and the `kable()` function in the R package `knitr` lets us do this easily.
