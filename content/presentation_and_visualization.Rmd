...
Note that our use of color here will allow us to represent the variable 'island', but if we just wanted to make all of our points blue or something we could use:
