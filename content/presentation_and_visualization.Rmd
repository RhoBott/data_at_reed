...
The formatting allows you to incorporate headings and subheadings, for easy and consistent formatting in the output document. In each code "chunk," there are also presets which can determine whether you want to show your code, output, warnings, or error messages in the output document. These features make R Markdown a great teaching and presentation tool.
