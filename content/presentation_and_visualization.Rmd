...
We can customize the look of the table with `kable_classic()` as an alternitive to `kable_styling()`. There's also `kable_paper`, `kable_classic_2`,`kable_minimal`, `kable_material` and `kable_material_dark`. 
