...
Logical and Boolean operators are used with `filter()`. The two pieces of code below (`?base::Logic` and `?Comparison`) give more information on the different operators and their uses. 
