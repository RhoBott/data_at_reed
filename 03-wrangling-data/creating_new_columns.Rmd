...
```
The syntax for mutating an existing column and creating a new column follows the pattern of `mutate(newcolumn = oldcolumn * operation)`, with "operation" being whatever change you are making to the old column to create the new column.
